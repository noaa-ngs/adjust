# adjust
Adjust software can be used to perform a weighted least squares adjustment of horizontal field observations and earth centered differential XYZ data (i.e., GPS data) in the NGS bluebook formats.
